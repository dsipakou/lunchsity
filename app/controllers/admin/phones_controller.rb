class Admin::PhonesController < ApplicationController
  ...
  # GET /admin/phones
  # GET /admin/phones.json
  def index
    @phones = Phone.all
  end

  # GET /admin/phones/1
  # GET /admin/phones/1.json
  def show
  end
  ...
  private
    ...
    def phone_params
      params.require(:phone).permit(:number, :operator, :phonetype)
    end
end
